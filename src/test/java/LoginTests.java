...
public class LoginTests {
  ...
  public void shouldDisplayLoginScreenElements() {
    ...
    Assert.assertTrue(
        loginPage.isLoginButtonDisabled(), "Botão de login deveria estar desabilitado.");
  }
  ...
  public void shouldNotAllowLoginWithInvalidCredentials() {
    ...
    Assert.assertTrue(
        loginPage.getToastContentText("Não foi possivel realizar login com este usuário."));
  }
  ...
  public void shouldNavigateToSignupScreen() {
    ...
    Assert.assertTrue(
        ...
        "URL não redirecionou corretamente para a tela de cadastro.");
  }
  ...
  public void shouldNavigateToRecoverPasswordScreen() {
    ...
    String currentUrl = driver.getCurrentUrl();
    Assert.assertTrue(
        currentUrl.contains("/recover-password"),
